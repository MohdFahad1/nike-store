        ...
        {/* TEXT PART */}
            <div className="lg:w-[530px] md:w-[530px] w-auto">
                <div className="lg:px-0 px-3">
                    ...
                    <h1 className="lg:text-8xl md:text-8xl text-7xl font-bold capitalize lg:w-[800px] w-auto bg-white lg:z-10 md:z-0 relative">the new arrival <span className="text-[#FF6452]">nike</span> shoes</h1>
            ...
            <div className="lg:static relative h-auto">
                    <Image src={bg} alt="bg" className="absolute top-0 h-full w-auto" priority={true}/>
                    <div>
                    ...
                    <div className="relative flex items-center lg:gap-12 md:gap-12 gap-3 lg:mt-[110px] md:mt-[180px] mt-[20px]">
                        ...
                        <div className={`relative  overflow-hidden lg:h-[200px] md:h-[200px] after:h-[110px]  lg:w-[200px] md:w-[200px]  w-[120px] ${isImage === shoe1 ? 'border-2 border-[#FF6452]' : '' }  rounded-xl flex justify-center items-center cursor-pointer`} onClick={() => setIsImage(shoe1)}>
                            <Image src={thumbnailBg} alt="bg" className="absolute h-auto w-auto" priority={true}/>
